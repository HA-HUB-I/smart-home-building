...
echo "    nano $SCRIPT_DIR/nginx.conf.secure"
echo ""
echo "2. Copy to nginx sites-available:"
echo "    cp $SCRIPT_DIR/nginx.conf.secure /etc/nginx/sites-available/webportal"
echo ""
echo "3. Enable the site:"
echo "    ln -sf /etc/nginx/sites-available/webportal /etc/nginx/sites-enabled/"
echo ""
